INSERT INTO produse (denumire, descriere, gramaj, pret) VALUES
...
INSERT INTO abonat (nume, adresa, nr_telefon, email, data_abonare, procent_discount) VALUES
...
INSERT INTO comanda (id_abonat, data_comanda, pret_total) VALUES
(1, '2024-01-15', 30.00),   -- Comanda 1: Paracetamol (2x15.00)
(2, '2024-01-20', 75.10),   -- Comanda 2: Amoxicilina (1x75.10)
(20, '2024-02-10', 30.10),  -- Comanda 3: Metformin (1x30.10)
(4, '2024-02-15', 20.18),   -- Comanda 4: Lisinopril (2x10.09)
(2, '2024-03-05', 40.20),   -- Comanda 5: Prednisolon (1x40.20)
(20, '2024-03-12', 200.16), -- Comanda 6: Diclofenac (2x100.08)
(7, '2024-04-01', 100.30),  -- Comanda 7: Rosuvastatin (2x50.15)
(8, '2024-04-08', 18.50),   -- Comanda 8: Ibuprofen (1x18.50)
(9, '2024-05-20', 12.50),   -- Comanda 9: Cetirizina (1x12.50)
(10, '2024-05-25', 36.45),  -- Comanda 10: Simvastatina (3x12.15)
(17, '2024-06-10', 20.20),  -- Comanda 11: Atorvastatin (2x10.10)
(2, '2024-06-18', 50.50),   -- Comanda 12: Amlodipina (1x50.50)
(13, '2024-07-05', 460.24), -- Comanda 13: Clopidogrel: (2x230.12)
(14, '2024-07-12', 140.36), -- Comanda 14: Warfarina (2x70.18)
(5, '2024-08-01', 12.75),   -- Comanda 15: Aspirina (1x12.75)
(13, '2024-08-08', 15.20),  -- Comanda 16: Omeprazol (1x15.20)
(17, '2024-09-03', 10.30),  -- Comanda 17: Levothyroxine (1x10.30)
(5, '2024-09-10', 20.50),   -- Comanda 18: Metoprolol (1x20.50)
(19, '2024-10-05', 10.12),  -- Comanda 19: Furosemid (1x10.12)
(20, '2024-10-12', 300.60); -- Comanda 20: Esomeprazol (3x100.20)

INSERT INTO medicamente_comandate (id_comanda, id_medicament, cantitate, pret_total) VALUES
(1, 1, 2, 30.00),    -- Paracetamol: 2 x 15.00
(2, 4, 1, 75.10),    -- Amoxicilina: 1 x 75.10
(3, 7, 1, 30.10),    -- Metformin: 1 x 30.10
(4, 10, 2, 20.18),   -- Lisinopril: 2 x 10.09
(5, 13, 1, 40.20),   -- Prednisolon: 1 x 40.20
(6, 16, 2, 200.16),  -- Diclofenac: 2 x 100.08
(7, 19, 2, 100.30),  -- Rosuvastatin: 2 x 50.15
(8, 2, 1, 18.50),    -- Ibuprofen: 1 x 18.50
(9, 5, 1, 12.50),    -- Cetirizina: 1 x 12.50
(10, 8, 3, 36.45),   -- Simvastatina: 3 x 12.15
(11, 11, 2, 20.20),  -- Atorvastatin: 2 x 10.10
(12, 14, 1, 50.50),  -- Amlodipina: 1 x 50.50
(13, 17, 2, 460.24), -- Clopidogrel: 2 x 230.12
(14, 20, 2, 140.36), -- Warfarina: 2 x 70.18
(15, 3, 1, 12.75),   -- Aspirina: 1 x 12.75
(16, 6, 1, 15.20),   -- Omeprazol: 1 x 15.20
(17, 9, 1, 10.30),   -- Levothyroxine: 1 x 10.30
(18, 12, 1, 20.50),  -- Metoprolol: 1 x 20.50
(19, 15, 1, 10.12),  -- Furosemid: 1 x 10.12
(20, 18, 3, 300.60); -- Esomeprazol: 3 x 100.20

INSERT INTO stocuri (id_medicament, stoc) VALUES
(1, 100),   -- Paracetamol
(2, 200),   -- Ibuprofen
(3, 150),   -- Aspirina
(4, 80),    -- Amoxicilina
